...
export const createOrganizationTaskSchemaClient = z.object({
...
export type CreateOrganizationTaskSchemaClientData = z.infer<typeof createOrganizationTaskSchemaClient>
