// @/modules/fleet/shared/ui/drivers/drivers-toolbar.tsx
"use client"
...
export const DriversToolbar = ({ table }: DriversToolbarProps) => {
	...
	return (
		<div className="flex flex-1 flex-wrap items-center gap-2">
			<InputGroup className="h-8 w-full sm:w-[240px] lg:w-[280px]">
				...
				<InputGroupInput className="h-8" placeholder="Buscar por nome, e-mail ou placa..." value={globalFilter} onChange={(event) => table.setGlobalFilter(event.target.value)} aria-label="Buscar motoristas" />
			</InputGroup>
