...
export async function rejectDriverApplicationService(params: RejectDriverApplicationServiceParams): AppResultAsync<RejectDriverApplicationServiceData, RejectDriverApplicationServiceCodes> {
	try {
