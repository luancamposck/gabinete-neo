						...
						<form onSubmit={form.handleSubmit(onSubmit)} className="p-6 md:p-8" noValidate>
							<div className="flex flex-col gap-6">
								<div className="flex flex-col items-center text-center">
									...
									<p className="text-muted-foreground text-balance">Cadastre-se para acessar o Gabinete NEO</p>
								</div>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormControl>
												<Input placeholder="Pedro Souza da Silva" autoComplete="name" disabled={isPending} {...field} />
											</FormControl>
											<FormMessage />
										</FormItem>
									)}
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormControl>
												<Input {...field} placeholder="123.456.789-10" onChange={(e) => field.onChange(maskCpf(e.target.value))} autoComplete="cpf" disabled={isPending} />
											</FormControl>
											<FormMessage />
										</FormItem>
									)}
