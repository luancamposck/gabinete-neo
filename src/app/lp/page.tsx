  ...
  return (
    <main className="relative overflow-hidden bg-background text-foreground">
      ...
      >
        ...
        >
          <Badge className="border-none bg-transparent p-0 text-base shadow-none">
      ...
      >
        <motion.div variants={fadeInOnScroll}>
          ...
          <p className="mt-4 text-balance text-base text-muted-foreground sm:text-lg">
            Conheça o fluxo completo de gestão de uma campanha política digital
            — do planejamento à vitória nas urnas. A demonstração guiada mostra
            como cada módulo do Gabinete Neo simplifica decisões e multiplica
            resultados.
          </p>
        </motion.div>
      ...
      >
        <div className="rounded-3xl border border-primary/40 bg-gradient-to-br from-primary/15 via-background to-background px-8 py-16 text-center shadow-lg backdrop-blur sm:px-16">
          ...
          <p className="mt-6 text-sm text-muted-foreground">
            🚀 Em média, campanhas que usam o Gabinete Neo reduzem 40% do tempo
            operacional e aumentam o engajamento em até 3x.
          </p>
        </div>
      </motion.section>
      ...
      >
        ...
        <p className="mt-6 text-sm text-muted-foreground">
          © 2025 Gabinete Neo. Plataforma SaaS para campanhas políticas modernas
          e transparentes.
        </p>
      </motion.footer>
    </main>
