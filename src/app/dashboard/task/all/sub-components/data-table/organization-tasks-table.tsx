...
const fuzzyFilter: FilterFn<OrganizationTaskDTO> = (row, _columnId, value, addMeta) => {
...
export const OrganizationTasksTable = ({ data }: OrganizationTasksTableProps) => {
	...
	const table = useReactTable({
		data: data ?? [],
		columns: organizationTasksColumns as ColumnDef<OrganizationTaskDTO>[],
		filterFns: {
			fuzzy: fuzzyFilter
		},
		state: {
